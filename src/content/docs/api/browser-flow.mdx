...
6. **Private download flow:** allocate, submit, poll, and stream an asynchronous `/web/dlp/jobs/...` job. YouTube always takes this path in the official client; cookies are optional browser-generated ciphertext. See [Private downloads (DLP)](/api/private-downloads-dlp/).
</Steps>
