...
The source is mounted read-only. Named volumes hold installed dependencies, `.next-build`, and synchronized `public/ffmpeg` assets. Recreate these disposable volumes if a corrupt dependency/build cache survives an update.
